...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Override
    @Transactional
    public ItemRequestDto addItemRequest(Long userId, ItemRequestrDtoCreateRequest itemRequestrDtoCreateRequest) {
        ItemRequest itemRequest = ItemRequestMapper.toItemRequest(itemRequestrDtoCreateRequest, userRepository.findById(userId)
    ...
    public Collection<ItemRequestDto> getAllItemRequests() {
        ...
        return itemRequestRepository.findAll(sort).stream()
                ...
                .toList();
        //itemRequestRepository.findAll().stream().sorted(o1,o2  ->o.getCreated())
    }
